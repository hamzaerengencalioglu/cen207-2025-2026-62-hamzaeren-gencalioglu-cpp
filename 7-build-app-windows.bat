...
call reportgenerator "-title:Local Event Planner Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/local_event_planner_app_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/local_event_planner/src;src/local_event_planner/header;src/local_event_planner_app/src;src/local_event_planner_app/header;src/tests/utility;src/tests/local_event_planner" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
